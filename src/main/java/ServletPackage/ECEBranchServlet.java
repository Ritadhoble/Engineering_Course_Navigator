...
import DAOPackage.ECEBranchDAO;
@SuppressWarnings("serial")
@WebServlet("/ece")
public class ECEBranchServlet extends HttpServlet 
{
	 protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
	    	String semester = req.getParameter("sem");
	        SubjectBean sb = new ECEBranchDAO().subjDetail(semester);
            if (sb != null) {
	            ...
	            if (c == null) {
	                ...
	                sct1.setAttribute("branch", "Electrical Engineering");
