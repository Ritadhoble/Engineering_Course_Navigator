...
import DAOPackage.ECTBranchDAO;
@SuppressWarnings("serial")
@WebServlet("/ect")
public class ECTBranchServlet extends HttpServlet
{
	 protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
	    	String semester = req.getParameter("sem");
	    	SubjectBean sb = new ECTBranchDAO().subjDetail(semester);
            if (sb != null) {
	            ...
	            if (c == null) {
	                ...
	                sct1.setAttribute("branch", "Electronics Engineering");
