...
import DAOPackage.CVEBranchDAO;
@SuppressWarnings("serial")
@WebServlet("/cve")

public class CVEBranchServlet extends HttpServlet
{
	 protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
	    	String semester = req.getParameter("sem");
	        SubjectBean sb = new CVEBranchDAO().subjDetl(semester);
	        ...
	        if (sb != null) {
	            ...
	            if (c == null) {
	                ...
	                sct1.setAttribute("branch", "Civil Engineering");
