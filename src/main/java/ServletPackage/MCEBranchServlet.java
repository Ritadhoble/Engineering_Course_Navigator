...
import DAOPackage.MCEBranchDAO;
@SuppressWarnings("serial")
@WebServlet("/mce")
public class MCEBranchServlet extends HttpServlet 
{
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException 
	 {
	    	String semester = req.getParameter("sem");
	    	SubjectBean sb = new MCEBranchDAO().subjectDetl(semester);
	        ...
	        if (sb != null) {
	            ...
	            if (c == null) {
	                ...
	                sct1.setAttribute("branch", "Mechanical Engineering");
