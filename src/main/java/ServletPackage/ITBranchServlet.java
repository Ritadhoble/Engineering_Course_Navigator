...
import DAOPackage.ITBranchDAO;
@SuppressWarnings("serial")
@WebServlet("/it")
public class ITBranchServlet extends HttpServlet
{
	 protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException 
	 {
	    	String semester = req.getParameter("sem");
	        SubjectBean sb = new ITBranchDAO().subDetail(semester);
            if (sb != null) {
	            ...
	            if (c == null) {
	                ...
	                sct1.setAttribute("branch", "Information Technology");
